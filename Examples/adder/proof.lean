/-
Proof module for `Examples/adder/spec.lean` (three-file example layout,
...
The rest is the house architecture (`Examples/counter/proof.lean`): one
...
equal to `Examples/adder/adder.sv.json`.
-/
import LeanModels.Sv.ToggleExample

namespace Examples.adder.proof
...
`Examples/xsel/proof.lean` (they live in `LeanModels/Sv/ToggleExample.lean`,
