/-
Proof module for `Examples/counter/spec.lean` (three-file example layout,
...
The proof architecture (same as `Examples/swap_nba/proof.lean`): one
...
equal to `Examples/counter/counter.sv.json`.
-/
import LeanModels.Sv.Delab

namespace Examples.counter.proof
