/-
Examples/python/arith — three-file example layout (see Examples/python/tri/spec.lean
...
`Examples.python.arith.proof`). This example is primarily a semantic check
matrix; its two theorems specify the runtime-error paths.
-/
import Examples.python.arith.proof
