/-
Examples/python/fib — three-file example layout (see Examples/python/tri/spec.lean for
the pattern rationale): fib.py (pure Python), fib.json (generated
envelope), THIS FILE (statements, `:= by proofs`), proof.lean (the real
proofs, namespace `Examples.python.fib.proof`). The mathematical model `fibSpec`
...
-/
import Examples.python.fib.proof
...
symbolic execution): `Examples/python/fib/proof.lean`. -/
