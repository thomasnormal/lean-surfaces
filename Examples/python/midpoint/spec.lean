/-
Examples/python/midpoint — three-file example layout (see Examples/python/tri/spec.lean
...
(the real proofs, namespace `Examples.python.midpoint.proof`).
-/
import Examples.python.midpoint.proof
