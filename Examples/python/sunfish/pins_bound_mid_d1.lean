/-
sunfish pin shard: the MIDGAME board `posMid` at DEPTH 1.
...
namespace Examples.python.sunfish.pins_bound_mid_d1

open LeanModels LeanModels.Python
open Examples.python.sunfish.pins

-- midgame, depth 1 (71 nodes across the pair)
#guard boundProbe posMid 0 1 == some (2, 66)
#guard boundProbe posMid 60 1 == some (35, 5)

end Examples.python.sunfish.pins_bound_mid_d1
