/-
sunfish pin shard: the MIDGAME board `posMid` at DEPTH 2.
...
namespace Examples.python.sunfish.pins_bound_mid_d2

open LeanModels LeanModels.Python
open Examples.python.sunfish.pins

-- midgame, depth 2 (826 nodes across the pair)
#guard boundProbe posMid 0 2 == some ((-1), 586)
#guard boundProbe posMid 60 2 == some (59, 240)

end Examples.python.sunfish.pins_bound_mid_d2
