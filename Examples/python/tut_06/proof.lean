/-
Proof module for `Examples/python/tut_06/spec.lean` (three-file example layout).
Every theorem stated in spec.lean is proved here under the same name; the
spec side is `:= by proofs`, which resolves `Examples.python.tut_06.proof.<decl>`
...
namespace Examples.python.tut_06.proof

open LeanModels LeanModels.Python

load_program tut_06 from "Examples/python/tut_06/tut_06.json"
...
end Examples.python.tut_06.proof
