/-
Proof module for `Examples/race_blk/spec.lean` (three-file example layout,
...
equal to `Examples/race_blk/race_blk.sv.json`.
-/
import LeanModels.Sv.Delab

namespace Examples.race_blk.proof

open LeanModels.Sv

/-- `Examples/race_blk/race_blk.sv` (blocking assigns — the race). -/
