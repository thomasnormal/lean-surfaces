/-
Proof module for `Examples/system-verilog/swap_nba/spec.lean` (three-file example layout,
...
equal to `Examples/system-verilog/swap_nba/swap_nba.sv.json`.
-/
import LeanModels.Sv.Delab

namespace Examples.«system-verilog».swap_nba.proof

open LeanModels.Sv

/-- `Examples/system-verilog/swap_nba/swap_nba.sv` (nonblocking assigns — the correct
swap). -/
...
end Examples.«system-verilog».swap_nba.proof
