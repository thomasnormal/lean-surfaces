/-
Examples/system-verilog/swap_nba — the three-file example layout (SV lane):
  ...
  proof.lean       — the real proofs (namespace `Examples.«system-verilog».swap_nba.proof`)
...
-/
import Examples.«system-verilog».swap_nba.proof
import LeanModels.Sv.Tests
import LeanModels

open LeanModels.Sv
open Examples.«system-verilog».swap_nba.proof (swapNbaDesign swapNbaTrace)
...
#eval show IO Unit from do
  let d ← EnvelopeIngest.loadFile "Examples/system-verilog/swap_nba/swap_nba.sv.json"
  unless d == swapNbaDesign do
    throw (IO.userError "Examples/system-verilog/swap_nba/swap_nba.sv.json ≠ swapNbaDesign")
...
state included. Raw form and proof: `Examples/system-verilog/swap_nba/proof.lean`. -/
