/-
Examples/system-verilog/toggle — the three-file example layout (SV lane):
  ...
  proof.lean     — the real proofs (namespace `Examples.«system-verilog».toggle.proof`)
...
-/
import Examples.«system-verilog».toggle.proof
import LeanModels.Sv.Tests
import LeanModels

open LeanModels.Sv
open Examples.«system-verilog».toggle.proof (toggleDesign toggleTrace toggleModel toggleModelRun)
...
#eval show IO Unit from do
  let d ← EnvelopeIngest.loadFile "Examples/system-verilog/toggle/toggle.sv.json"
  unless d == toggleDesign do
    throw (IO.userError "Examples/system-verilog/toggle/toggle.sv.json ≠ toggleDesign")
...
`Examples/system-verilog/toggle/proof.lean`. -/
