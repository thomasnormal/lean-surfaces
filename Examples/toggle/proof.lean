/-
Proof module for `Examples/toggle/spec.lean` (three-file example layout,
...
The proof architecture (same as `Examples/counter/proof.lean`): one
...
equal to `Examples/toggle/toggle.sv.json`.
-/
import LeanModels.Sv.ToggleExample

namespace Examples.toggle.proof

open LeanModels.Sv

/-! ## The design (extractor-certified literal) -/

/-- `Examples/toggle/toggle.sv`, hand-transcribed; `spec.lean`'s `#eval`
...
/--
info: 'Examples.toggle.proof.toggle_refines_model' depends on axioms: [propext, Classical.choice, Quot.sound]
-/
#guard_msgs in
#print axioms toggle_refines_model

/--
info: 'Examples.toggle.proof.toggle_from_reset' depends on axioms: [propext, Classical.choice, Quot.sound]
-/
#guard_msgs in
#print axioms toggle_from_reset

/--
info: 'Examples.toggle.proof.toggle_det' depends on axioms: [propext, Classical.choice, Quot.sound]
-/
#guard_msgs in
#print axioms toggle_det

end Examples.toggle.proof
