/-
Examples/tri — the three-file example layout (the migration pattern):
  ...
  proof.lean — the real proofs (namespace `Examples.tri.proof`)
...
clause form, `py_begin`/`py_loop`): `Examples/tri/proof.lean`. -/
