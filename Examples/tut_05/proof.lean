/-
Proof module for `Examples/tut_05/spec.lean` (three-file example layout).
Every theorem stated in spec.lean is proved here under the same name; the
spec side is `:= by proofs`, which resolves `Examples.tut_05.proof.<decl>`
...
namespace Examples.tut_05.proof

open LeanModels LeanModels.Python

load_program tut_05 from "Examples/tut_05/tut_05.json"
