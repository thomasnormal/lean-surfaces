...
**465 entries across 17 lanes.** Regenerate with
`tools/backlog-index.sh`; check with `--check` (exit 1 on drift).

| id | class | title | lane |
| --- | --- | --- | --- |
| `2026-08-27-pycomplete-46` |  | two operational notes bought by a mass deletion | python-completeness |
| `2026-08-26-architecture-93` |  | PAUSE MARKER: the campaign parks, and this is where a cold reader starts | architecture |
...
| `2026-08-26-pycomplete-45` |  | the migration, on a MEASURED map (resumed) | python-completeness |
| `2026-08-26-pycomplete-44` |  | PARKED (indefinite). Read this first on resumption. | python-completeness |
| `2026-08-26-pycomplete-43` |  | the migration's own premise was derived, not measured; and the structural fix is priced NO | python-completeness |
...
| `2026-08-26-softfloat-28` |  | PARKED. This entry is what resumption reads. | softfloat |
...
| `2026-08-26-analog-10` |  | the AssuranceCase census: the tier was never 9/21, and the instrument now says so | analog |
...
| `2026-08-25-qol-77` |  | envelope freshness, with the pin checked before anything is compared | qol |
| `2026-08-25-qol-75` |  | the index gate joins the floor, and two premises corrected | qol |
...
| `2026-08-25-softfloat-26` |  | 4c IN PROGRESS: the grid generalised, and distances become INTEGER comparisons | softfloat |
| `2026-08-25-pycomplete-26` |  | the register's three clauses, and a probe that was starting UNLOCKED BUILDS | python-completeness |
| `2026-08-25-softfloat-25` |  | THE COMMON-GRID REDUCTION: many grids become one | softfloat |
...
| `2026-08-26` |  | PARKED (indefinite). Read this first on resumption. | analog |
